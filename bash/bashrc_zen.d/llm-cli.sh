alias llm='llm -m anthropic/claude-sonnet-4-0'
alias llms='llm -m anthropic/claude-sonnet-4-0 -T web_search'
alias llmw='llm -m anthropic/claude-sonnet-4-0  -T web_search'
