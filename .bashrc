...
# less!  Be my everything
# export LESS="-iMFXRj4aQ"
export LESS="-iMFXRj4Q"
# -i, --IGNORE-CASE: <--- Essential
# -M, --LONG-PROMPT
# -F, --quit-if-one-screen:
# -X, --no-init: (Screen clearing?) Disables sending the termcap initialiazation and deinitialization strings  <--- Essential
# -R, --RAW-CONTROL-CHARS: Like -r, but only ANSI "color" escape seq are output in "raw" form
# -jn, --jump-target=n: Specifiy a line on the screen where the "target" line is to be positioned <--- Essentiall
# -a, --search-skip-screen: Forward searches start at bottom of screen, backward at top.  Skips the current screen --- X --- removed
